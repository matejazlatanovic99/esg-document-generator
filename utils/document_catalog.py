...
DOCUMENT_TYPES: dict[str, dict[str, dict]] = {
    ...
    "mobile_combustion": {
        ...
        "telematics_fuel": {
            ...
            "formats": ["XLSX", "CSV"],
            "implemented": True,
            "default_title": "Vehicle Telematics Report",
        ...
        "telematics_trips": {
            ...
            "formats": ["XLSX", "CSV"],
            "implemented": True,
            "default_title": "Vehicle Mileage Log",
            "default_subject": "Scope 1 mobile combustion mileage log",
        },
        "telematics_odometer": {
            "label": "Odometer Report",
            "formats": ["XLSX", "CSV"],
            "implemented": True,
            "default_title": "Odometer Report",
